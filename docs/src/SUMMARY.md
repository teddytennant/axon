...
- [Identity & Cryptography](./architecture/identity.md)
- [Discovery](./architecture/discovery.md)
- [Gossip Protocol](./architecture/gossip.md)
- [CRDTs](./architecture/crdts.md)
- [Routing](./architecture/routing.md)

# Agents

- [Agent Model](./agents/model.md)
- [Built-in Agents](./agents/builtin.md)
- [Writing Custom Agents](./agents/custom.md)

# LLM Providers

- [Provider System](./providers/overview.md)
